...
public class SignUpView extends AbstractFormView<SignUpData> {

    public static final String NAME = "signup";

    public SignUpView() {
        super(SignUpData.class, new SignUpData());
    }

    @Override
    protected void customizeForm(FormLayout formLayout, BeanFieldGroup<SignUpData> binder) {
