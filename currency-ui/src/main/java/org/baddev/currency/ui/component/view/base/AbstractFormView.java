...
import org.baddev.currency.ui.util.UIUtils;
...
public abstract class AbstractFormView<T> extends AbstractView
    ...
    protected AbstractFormView(Class<T> beanClass, String... panelStyles) {
        this(beanClass, BeanUtils.instantiate(beanClass), null, panelStyles);
    }
    ...
    protected AbstractFormView(Class<T> beanClass, Alignment panelAlignment, String... panelStyles) {
        this(beanClass, BeanUtils.instantiate(beanClass), panelAlignment, panelStyles);
    }
    ...
    public void postCommit(FieldGroup.CommitEvent commitEvent) throws FieldGroup.CommitException {
        if (getEventType() != null) {
            ...
            try {
                EventBus.post(BeanUtils.instantiateClass(getEventType().getConstructor(
                        Object.class, beanClass, BiConsumer.class, Consumer.class, FieldGroup.class),
                        this, formBean, commitFailed, commitSuccess, commitEvent.getFieldBinder()));
