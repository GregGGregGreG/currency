...
public class ExchangeOperation extends TableImpl<ExchangeOperationRecord> {
    ...
    private static final long serialVersionUID = -1645258742;
     ...
     */
    public final TableField<ExchangeOperationRecord, LocalDateTime> PERFORM_DATETIME = createField("perform_datetime", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "", new TimestampToLocalDateTimeConverter());
