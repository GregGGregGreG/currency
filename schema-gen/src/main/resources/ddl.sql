...
(
  ...
  CONSTRAINT user_password_history_user_id_fk FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE
);
...
(
  ...
  CONSTRAINT user_preferences_user_id_fk FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE
);
